...
class basic_income(DatedVariable):
    ...
    def function_from_2016_12(person, period, legislation):
        ...
        return age_condition * legislation(period).benefit.basic_income  # This '*' is a vectorial 'if'. See https://doc.openfisca.fr/coding-the-legislation/30_case_disjunction.html#simple-multiplication
