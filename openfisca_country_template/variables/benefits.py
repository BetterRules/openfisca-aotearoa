...
class basic_income(Variable):
    ...
    def formula_2016_12(person, period, parameters):
        ...
        return age_condition * parameters(period).benefits.basic_income  # This '*' is a vectorial 'if'. See https://doc.openfisca.fr/coding-the-legislation/30_case_disjunction.html#simple-multiplication
    ...
    def formula_2015_12(person, period, parameters):
        ...
        return age_condition * salary_condition * parameters(period).benefits.basic_income  # The '*' is also used as a vectorial 'and'. See https://doc.openfisca.fr/coding-the-legislation/25_vectorial_computing.html#forbidden-operations-and-alternatives
