...
class social_security__eligible_for_childcare_subsidy(Variable):
    ...
    def formula(persons, period, parameters):
        ...
        return is_citizen * (under_5_years_28_days_not_attending_school + is_5_and_will_be_enrolled + under_6_with_disability_allowance)
...
class social_security__has_child_under_5_not_in_school(Variable):
    ...
    def formula(families, period, parameters):
        ...
        return families.any((not_in_school * under_5), role=Family.CHILD)
...
class social_security__has_child_aged_5_who_will_be_enrolled_in_school(Variable):
    ...
    def formula(families, period, parameters):
        ...
        return families.any((children_to_be_enrolled * aged_5), role=Family.CHILD)
