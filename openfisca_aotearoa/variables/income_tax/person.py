...
class tax_payer_filing_status__income_tax(Variable):
    value_type = Enum
...
class annual_gross_income__income_tax(Variable):
    value_type = float
    entity = Person
    definition_period = YEAR
...
class annual_total_deduction__income_tax(Variable):
    value_type = float
    entity = Person
    definition_period = YEAR
...
class net_income__income_tax(Variable):
    value_type = float
    entity = Person
    definition_period = YEAR
    label = "Net income"
...
class net_loss__income_tax(Variable):
    value_type = float
    entity = Person
    definition_period = YEAR
    label = "Net loss"
...
class available_tax_loss__income_tax(Variable):
    value_type = float
    entity = Person
    definition_period = YEAR
...
class taxable_income__income_tax(Variable):
    value_type = float
    entity = Person
    definition_period = YEAR
    label = "Net loss"
