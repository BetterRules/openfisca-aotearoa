...
class social_security__is_a_specified_beneficiary(Variable):
    value_type = bool
    entity = Person
    definition_period = MONTH
    label = """he or she is a specified beneficiary within the meaning of paragraphs (b) to (d) of the definition
